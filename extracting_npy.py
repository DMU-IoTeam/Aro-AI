...
# ✅ 1. 저장 폴더 생성
os.makedirs("extracted_data/npy/train/fall", exist_ok=True)
os.makedirs("extracted_data/npy/train/normal", exist_ok=True)
os.makedirs("extracted_data/npy/val/fall", exist_ok=True)
os.makedirs("extracted_data/npy/val/normal", exist_ok=True)
...
def get_npy_save_path(video_path, label_type, dataset_type):
    ...
    return os.path.join(f"extracted_data/npy/{dataset_type}/{label_type}", f"{fname}.npy")
